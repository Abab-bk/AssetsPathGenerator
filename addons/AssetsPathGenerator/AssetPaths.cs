    ...
    public static class Assets
    {
		...
		public static class Characters
		{
			public static class CharactersSkeleton1
			{
				...
				public const string Face01 = @"res://Assets//Characters/Skeleton1/Face 01.png";
				public const string Face02 = @"res://Assets//Characters/Skeleton1/Face 02.png";
				public const string Face03 = @"res://Assets//Characters/Skeleton1/Face 03.png";
				public const string Head = @"res://Assets//Characters/Skeleton1/Head.png";
				public const string LeftArm = @"res://Assets//Characters/Skeleton1/Left Arm.png";
				public const string LeftHand = @"res://Assets//Characters/Skeleton1/Left Hand.png";
				public const string LeftLeg = @"res://Assets//Characters/Skeleton1/Left Leg.png";
				public const string RightArm = @"res://Assets//Characters/Skeleton1/Right Arm.png";
				public const string RightHand = @"res://Assets//Characters/Skeleton1/Right Hand.png";
				public const string RightLeg = @"res://Assets//Characters/Skeleton1/Right Leg.png";
